              ...
              <>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                    ...
                    <Link to="/wishlist" className="block py-2 px-4 text-gray-700 hover:text-primary-500" onClick={() => setIsMenuOpen(false)}
                  > Wishlist</Link>
                    <button
                      onClick={handleLogout}
                      className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100"
            ...
            <div className="space-y-2">
              ...
              {user ? (
                <>
                  ...
                  <Link to="/wishlist" className="block py-2 text-gray-700 hover:text-primary-500" onClick={() => setIsMenuOpen(false)}
                  > Wishlist</Link>
                  <button
                    onClick={() => {
                      handleLogout();
...
// import React, { useState } from 'react';
// import { Link, useNavigate } from 'react-router-dom';
// import { ShoppingCart, User, Menu, X, Send, History } from 'lucide-react'; // Added icons
// import { useAuth } from '../../context/AuthContext';
// import { useCart } from '../../context/CartContext';
// import SearchWithSuggestions from '../Search/SearchWithSuggestions';
...
//             {/* NEW: Payment Links - Only show for logged in users */}
//             {user && (
//               <>
//                 <Link to="/send-money" className="flex items-center space-x-1 text-gray-700 hover:text-primary-500 transition-colors">
//                   <Send className="h-5 w-5" />
//                   <span>Send Money</span>
//                 </Link>
//                 <Link to="/transactions" className="flex items-center space-x-1 text-gray-700 hover:text-primary-500 transition-colors">
...
//                     Wishlist
//                   </Link>
//                   <Link to="/payments/history" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
//                     Payment History
//                   </Link>
//                   <button
//                     onClick={handleLogout}
